...
# Sin worker daemon para lotes: batch_web_v2 procesa un SKU por petición HTTP.
CMD ["uvicorn", "batch_web_v2:fastapi_app", "--host", "0.0.0.0", "--port", "7860", "--proxy-headers", "--workers", "1"]
