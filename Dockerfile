...
ENV PORT=7860
# Una sola operación pesada a la vez: suficiente para analizar/generar o sincronizar un SKU.
...
# Suite IA + sincronización INDIVIDUAL. No carga ninguna ruta/worker de lotes.
